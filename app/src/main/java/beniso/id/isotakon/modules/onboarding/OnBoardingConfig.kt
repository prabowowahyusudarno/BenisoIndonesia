...
object OnBoardingConfig {
    ...
    private fun noSubHeaderStyle(): Text {
        val headerStyle = Text()
        headerStyle.color = "#00FFFFFF"
        headerStyle.font = "sans-serif-black"
        headerStyle.size = 32f
